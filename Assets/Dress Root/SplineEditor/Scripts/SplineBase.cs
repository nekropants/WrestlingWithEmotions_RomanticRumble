...
namespace Battlehub.SplineEditor
{
    ...
    {
        public event ControlPointChanged ControlPointChanged;
        private void RaiseControlPointChanged(int index)
        {
            if (ControlPointChanged != null)
            {
                ControlPointChanged(index);
            }
        }
        ...
        protected const int WRAP_DEFORM_VERSION = 1;
#if UNITY_EDITOR
        [SerializeField, HideInInspector]
        ...
        public SplineSnapshot CreateSplineSnapshot()
        {
        ...
        {
            return GetComponentsInChildren<SplineControlPoint>();
        }
        ...
        private void SyncCtrlPoints(bool silent = false)
        {
            ...
            else if (delta < 0)
            {
                ...
                ctrlPoints = GetComponentsInChildren<SplineControlPoint>();
#endif
